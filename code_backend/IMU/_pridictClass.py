...
"""
import argparse, os, joblib, numpy as np, torch
...
def load_resources():
    scaler = joblib.load(os.path.join(BASE, "weights/scaler.pkl"))
    le = joblib.load(os.path.join(BASE, "weights/label_encoder.pkl"))
