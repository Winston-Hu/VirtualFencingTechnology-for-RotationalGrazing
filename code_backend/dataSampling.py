...
# ===== CSV File Path =====
csv_path = "./rssi_measurements_z5511644_-1_0.csv"
    ...
    while len(rssi_list) < MEASURE_COUNT:
        ...
        for d, adv in devices.values():
            if adv.local_name == TARGET_NAME:
                ...
                payload = {"R_Location": MY_LOCATION, "RSSI": adv.rssi}
                json_payload = json.dumps(payload)

                publisher.push_message(BROKER, PORT, USERNAME, PASSWORD, TOPIC, json_payload)
